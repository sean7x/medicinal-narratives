...
if __name__ == "__main__":
    ...
    parser.add_argument("--cluster_bert", action="store_true", help="Clustering grid search")
    parser.add_argument("--topic", action="store_true", help="Topic modeling grid search")
    args = parser.parse_args()

    if args.cluster_bert:
        cluster_bert_grid_search()
    elif args.topic:
        topic_grid_search()
    else:
        print("Please specify a grid search to run, 'cluster_bert' or 'topic.")